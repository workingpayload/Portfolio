  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        Small Seletion of <span className="text-purple">recent projects</span>
      </h1>
        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              <div className=" sm:w-[570px] relative flex items-center justify-center sm:h-[40vh] h-[30vh] w-[80vw] overflow-hidden mb-10">
